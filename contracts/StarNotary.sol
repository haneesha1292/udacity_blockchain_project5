...
contract StarNotary is ERC721 {
    ...
    string public constant name  = "My Star Notary Token";
    string public constant symbol = "MSNT";
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        if(owner1 == msg.sender){
            ...
            receiverToken = _tokenId2;  
        }else if(owner2 == msg.sender){
            sender = owner2;
            receiver = owner1;
            senderToken = _tokenId2;
            receiverToken = _tokenId1;  
        }
        _transferFrom(sender, receiver, senderToken);
        _transferFrom(receiver, sender, receiverToken);
    }
